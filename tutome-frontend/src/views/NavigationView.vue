  ...
  <header class="bg-white">
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
      ...
      <PopoverGroup class="hidden lg:flex lg:gap-x-12">
        ...
        <a href="/courses" class="text-sm font-semibold leading-6 text-green-600">Cursos</a>
        <a href="/tutors" class="text-sm font-semibold leading-6 text-green-600">Tutores</a>
        <a href="/community" class="text-sm font-semibold leading-6 text-green-600">Comunidad</a>
        <a href="/profile" class="text-sm font-semibold leading-6 text-green-600">Perfil</a>
      </PopoverGroup>
      <div class="hidden lg:flex lg:flex-1 lg:justify-end">
        <a href="/login" class="text-sm font-semibold leading-6 text-green-600">Log Out <span
        ...
        <div class="mt-6 flow-root">
          <div class="-my-6 divide-y divide-gray-500/10">
            <div class="space-y-2 py-6">
              ...
              <a href="/courses"
                class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Cursos</a>
              <a href="/tutors"
                class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Tutores</a>
              <a href="/community"
                class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Comunidad</a>
              <a href="/profile"
