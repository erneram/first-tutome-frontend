               ...
               <div ref="container" class="flex flex-auto flex-col overflow-auto">
                    <div ref="containerNav"
                         ...
                         <button type="button" class="flex flex-col items-center pb-1.5 pt-3">
                              <span>T</span>
                              <span
                                   class="mt-3 flex h-8 w-8 items-center justify-center rounded-full text-base font-semibold text-green-600">20</span>
                         </button>
                         <button type="button" class="flex flex-col items-center pb-1.5 pt-3">
                              <span>F</span>
                              <span
                         ...
                         <div class="grid flex-auto grid-cols-1 grid-rows-1">
                              ...
                              <ol class="col-start-1 col-end-2 row-start-1 grid grid-cols-1"
                                   ...
                                   <li class="relative mt-px flex" style="grid-row: 134 / span 18">
                                        <a href="#"
                                             class="group absolute inset-1 flex flex-col overflow-y-auto rounded-lg bg-green-50 p-2 text-xs leading-5 hover:bg-green-100">
                                             <p class="order-1 font-semibold text-green-700">Sightseeing</p>
                                             <p class="order-1 text-green-500 group-hover:text-green-700">Eiffel Tower
                                             </p>
